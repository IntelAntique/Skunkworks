...
gtd_data = pd.read_csv('database.csv')
...
# Function to check if the values are within 0.5
def is_within_0_5(value1, value2):
    return abs(value1 - value2) <= 0.5
...
total_entries_with_duplicates = len(llm_data)
...
# Print results
print(f"Total Entries with Duplicates: {total_entries_with_duplicates}")
